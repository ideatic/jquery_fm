 ...
 */
class jExplorer_FileManager
{
    /**
     * Provider used to list and manipulate files.
     * This is a read only property
     * @var jExplorer_FileProvider
     */
    public $provider;
    ...
    public function __construct(jExplorer_FileProvider $provider)
    {
    ...
    public function render($id)
    {
        ...
        $settings = array(
            ...
            'max_file_size_readable' => jExplorer_FileManagerHelper::format_size($this->max_size),
        ...
        ?>
        <script>
            jQuery('#<?= $id ?>').jExplorer(<?= json_encode($settings) ?>);
        </script>
        <?php
        return ob_get_clean();
    }
