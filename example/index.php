<?php
require '../lib/backend/FileManager.php';
require '../lib/backend/FileProvider.php';
require '../lib/backend/FileProviderFS.php';
require '../lib/backend/FileManagerHelper.php';

//Full featured file manager
$manager = new FileManager(new FileProviderFS(dirname(__FILE__) . '/testdir/'));
$manager->ajax_endpoint = '?isolated=true';
$manager->icons_url = 'static/icons';

//Basic file explorer
$basic = new FileManager(new FileProviderFS(dirname(__FILE__) . '/testdir/'));
...
<head>
    ...
    <link href="../lib/css/jquery_fm.min.css" rel="stylesheet">
...
<script src="../lib/js/jquery_fm.js"></script>
<?php
