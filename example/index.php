...
$manager = new jExplorer_FileManager(new jExplorer_FileProviderFS(dirname(__FILE__) . '/testdir/'));
$manager->ajax_endpoint = '?isolated=true';
$manager->icons_url = 'static/icons';

//Basic file explorer
$basic = new jExplorer_FileManager(new jExplorer_FileProviderFS(dirname(__FILE__) . '/testdir/'));
...
<head>
    ...
    <link href="../assets/css/jExplorer.min.css" rel="stylesheet">
...
<script src="../assets/js/jExplorer.js"></script>
<?php
