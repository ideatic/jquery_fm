        ...
        <div class="file" data-file="<?php echo $file->name ?>">
            <div class="image-holder">             
                <?php if ($file->is_folder): ?>
                    <button class="open_folder" title="<?php echo $this->strings['explore'] ?>"><img src="<?php echo $img_src ?>" onerror="this.onerror='';this.src='<?php echo $default_img ?>'" /></button>
                <?php else: ?>
                    <form action="<?php echo $this->ajax_endpoint ?>" method="POST">
                        ...
                        <button type="submit" title="<?php echo $this->strings['download'] ?>"><img src="<?php echo $img_src ?>" onerror="this.onerror='';this.src='<?php echo $default_img ?>'" /></button>
                    </form> 
                <?php endif; ?>                   
            </div>
